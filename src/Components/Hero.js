...
const Hero = () => {
    return(
        <div style={{height:'calc(100vh - 64px)'}} className="text-gray-100 flex justify-center items-center flex-col text-center">
            ...
            <span className="font-baskerville text-gray-300 mx-9">I ensure visitors comfortable when interact with the web page.</span>
            <a href="#project" className="btn-primary py-3 px-6 mt-16">See my projects</a>
        </div>
    )
}
